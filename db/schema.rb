...
ActiveRecord::Schema.define(version: 2022_03_07_163151) do
  ...
  create_table "bets", force: :cascade do |t|
    ...
    t.index ["publisher_id"], name: "index_bets_on_publisher_id"
  end
  ...
  add_foreign_key "bets", "users", column: "publisher_id"
